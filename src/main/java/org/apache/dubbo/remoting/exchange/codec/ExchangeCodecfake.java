 ...
 * ExchangeCodec.
 */
public class ExchangeCodecfake extends TelnetCodec {
    ...
    private static final ErrorTypeAwareLogger logger = LoggerFactory.getErrorTypeAwareLogger(ExchangeCodecfake.class);
